...
/**
 * Test PDF Processing Endpoint - Production Worker
 * Test the production worker with PDF.co API key
 */
...
// Configuration - Use development worker
...
console.log('🧪 Test PDF Processing Endpoint - Production Worker');
console.log('==================================================\n');

/**
 * Test PDF processing endpoint on production worker
 */
async function testPdfProcessingProduction() {
  try {
    ...
    console.log(
      `🚀 Worker Deployed: YES (Version: 91c9af9d-330b-45d0-8d59-895f1fe2588b)`
    );
    console.log(
